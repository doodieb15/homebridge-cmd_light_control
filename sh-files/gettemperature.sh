...
myurl="http://$server_ip:$server_port/goform/ReadWrite?redirect=lights%2Fbrightness.asp&variable=Zimmer%5B$light_id%5D.Temp_ist_flt&value="$light_value"000&read=Read"
